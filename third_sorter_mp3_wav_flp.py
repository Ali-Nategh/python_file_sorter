...
"""
This is a File sorter that sorts mp3, wav and flp (FL studio project) files by extentions.
...
for files in os.walk(srcPath):
    for file in files[2]:
        ...
        for mp3 in mp3Ext:
            if "." in file and file.split(".")[-1].lower() == mp3.lower():
                filecreation("mp3s")
        for wav in wavExt:
            if "." in file and file.split(".")[-1].lower() == wav.lower():
                filecreation("waves")
        for fl in flExt:
            if "." in file and file.split(".")[-1].lower() == fl.lower():
                filecreation("flProjs")
